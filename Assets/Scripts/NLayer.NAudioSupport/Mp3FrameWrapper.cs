...
namespace NLayer.NAudioSupport
{
    class Mp3FrameWrapper : IMpegFrame
    {
        ...
        public int ChannelModeExtension => _mpegFrameImplementation.ChannelModeExtension;
...
//        }
        ...
        public int BitRateIndex => _mpegFrameImplementation.BitRateIndex;

        public bool IsCopyrighted => _mpegFrameImplementation.IsCopyrighted;

        public bool HasCrc => _mpegFrameImplementation.HasCrc;
        ...
        ulong _bitBucket;
        private IMpegFrame _mpegFrameImplementation;
